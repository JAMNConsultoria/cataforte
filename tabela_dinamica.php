...
foreach ($_SESSION['posicao'] as $var => $row) {
	if (strpos($row['pos'], 'L') !== FALSE) {
		$linhas[$row['ordem'].$var] = $var;
	} elseif (strpos($row['pos'], 'C') !== FALSE) {
...
<tr>
<td align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><strong>Fonte</strong>: Projeto Cataforte ..... <strong><a href="imp.php?page=varinfpop" target="_blank">Defini&ccedil;&otilde;es e Notas</a></strong></font></td>
</tr>
</table></div>
<br />
<br />
